...
public:
    ...
    void update(uint16_t eoj, byte epcpdcedt[]);

    // sender
    virtual void send(IPAddress toip, byte sBuffer[], int size);
    void sendOPC1(const IPAddress toip, const byte *tid, const byte *seoj, const byte *deoj, const byte esv, const byte *epcedt);
    void sendOPC1(const IPAddress toip, const byte *seoj, const byte *deoj, const byte esv, const byte *epcedt);
    void sendOPC1(const IPAddress toip, const byte *deoj, const byte esv, const byte *epcedt);
    void sendOPC1(const IPAddress toip, const int devId, const byte *deoj, const byte esv, const byte *epcpdcedt);
    void sendBroad(byte sBuffer[], int size);
    void sendMulti(byte sBuffer[], int size);
    void sendMultiOPC1(const byte *tid, const byte *seoj, const byte *deoj, const byte esv, const byte *epcedt);
    void sendMultiOPC1(const byte *seoj, const byte *deoj, const byte esv, const byte *epcedt);
    void sendMultiOPC1(const byte *deoj, const byte esv, const byte *epcedt);
    void sendMultiOPC1(const int devId, const byte *deoj, const byte esv, const byte *epcpdcedt);
    void sendOPCn(const IPAddress toip, const byte *tid, const byte *seoj, const byte *deoj, const byte esv, const byte opc, const byte *epcpdcedt[]);
    void sendMultiOPCn(const byte *tid, const byte *seoj, const byte *deoj, const byte esv, const byte opc, const byte *epcpdcedt[]);

    // receiver
    int read();
    IPAddress remoteIP(void);
    void returner(void);
    void returner(IPAddress addr, byte rbuf[]);
    void extractEpc(byte rbuf[], std::vector<byte> &v);
